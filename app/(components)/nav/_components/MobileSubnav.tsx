...
const SubnavVariants = cva(
  "absolute top-12 left-0 z-50 w-full h-[calc(100vh-3rem)] py-10 px-4 animate-opacityEffect bg-secondary/50 dark:bg-dark dark:text-secondary moblie:block laptop:hidden desktop:hidden"
);
